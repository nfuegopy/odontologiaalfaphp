  ...
  <div class="container">
    <div class="row justify-content-center mt-5">
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Crear Rol</h2>
          
            <form id="rolForm" class="ajax-form" method="POST" action="../conexion/cargarol.php">
      ...
      $(".ajax-form").submit(function(event) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            setTimeout(function() {
              window.location.href = "../mantenimiento/rol.php";
            }, 2000);
          },
