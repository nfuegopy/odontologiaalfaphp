  ...
  <div class="container">
    <div class="row justify-content-center mt-5">
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Crear Especialidad</h2>
            <form id="especialidadForm" class="ajax-form" method="POST" action="../conexion/cargaespecialidad.php">
      ...
      $(".ajax-form").submit(function(event) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            setTimeout(function() {
              window.location.href = "../mantenimiento/especialidad.php";
            }, 2000);
          },
